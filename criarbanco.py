...
query = 'CREATE TABLE IF NOT EXISTS nome_da_tabela ('
for coluna, tipo_de_dado in zip(colunas, tipos_de_dados):
    if tipo_de_dado == 'int64':
        tipo_de_dado_sql = 'INTEGER'
    elif tipo_de_dado == 'float64':
        tipo_de_dado_sql = 'REAL'
    elif tipo_de_dado == 'object':
        tipo_de_dado_sql = 'TEXT'
    else:
        tipo_de_dado_sql = 'TEXT'  # Defina o tipo de dado padrão como TEXT
